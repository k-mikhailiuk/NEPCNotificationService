...
/// <summary>
/// Валидатор для команды DTO объекта AggregatorCntLimit.
/// </summary>
/// <remarks>
/// Устанавливает правила валидации для свойств объекта AggregatorCntLimitDto.
/// </remarks>
public class AggregatorCntLimitDtoCommandValidator : AbstractValidator<AggregatorCntLimitDto>
{
    /// <summary>
    /// Инициализирует новый экземпляр <see cref="AggregatorCntLimitDtoCommandValidator"/> и задаёт правила валидации.
    /// </summary>
