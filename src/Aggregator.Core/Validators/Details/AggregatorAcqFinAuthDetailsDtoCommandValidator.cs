...
/// <summary>
/// Валидатор для команды DTO объекта деталей авторизации AcqFinAuth.
/// </summary>
/// <remarks>
/// Устанавливает правила валидации для свойств объекта AggregatorAcqFinAuthDetailsDto.
/// </remarks>
public class AggregatorAcqFinAuthDetailsDtoCommandValidator : AbstractValidator<AggregatorAcqFinAuthDetailsDto>
{
    /// <summary>
    /// Инициализирует новый экземпляр <see cref="AggregatorAcqFinAuthDetailsDtoCommandValidator"/> и задаёт правила валидации.
    /// </summary>
