...
/// </summary>
/// <typeparam name="T">Тип DTO уведомления, реализующий <see cref="NotificationAggregatorBaseDto"/>.</typeparam>
...
public record ProcessNotificationCommand<T>(List<T> Notifications) : IRequest<List<long>> where T : NotificationAggregatorBaseDto;