...
/// </summary>
public record AggregatorAcctBalChangeDetailsDto
{
    /// <summary>
    ...
    /// </summary>
    public AggregatorAuthorizationDto? Auth { get; init; }
    
    /// <summary>
    /// Информация о финансовой транзакции
    /// </summary>
    public AggregatorTransactionDto? FinTrans { get; init; }
    ...
    /// </summary>
    public AggregatorMoneyDto AccountAmount { get; init; }
